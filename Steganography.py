...
def encode_txt_data():
    count2=0
    txt_path = input("Enter Cover txt file path: ")
    ...
    for i in img:
        for pixel in i:
            ...
            for byte in total_bytes:
                ...
                if decoded_data[-5:] == "*^*^*":
                    #with open("Ecoded_data.txt", "w") as file:
                        #file.write(decoded_data[:-5])
                    #print("\n\nThe Encoded data which was hidden in the Image is saved in Encoded_data.txt")
                    print("\n\nThe Encoded data which was hidden in the Image is :- ",decoded_data[:-5])
                    return 
...
def encode_vid_data():
    vid_path = input("Enter Path of the Cover Video: ")
...
def decode_vid_data(frm):
    seg_path=input("Enter stego video path :")
